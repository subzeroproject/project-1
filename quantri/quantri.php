...
$sql="SELECT * FROM thanhvien WHERE email='".$_SESSION['email']."' AND mat_khau='".$_SESSION['mk']."'";
                    ...
                    <div class="navbar-header">
                        ...
                        <ul class="user-menu">
                            <li class="dropdown pull-right">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg><span style="color: white;">Xin chào, <?php if (isset($_SESSION["email"])) {
        echo $_SESSION["email"];
